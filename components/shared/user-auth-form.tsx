...
export function UserAuthForm({ isLoggingIn }: { isLoggingIn: boolean }) {
      ...
      <form onSubmit={onSubmit}>
        <div className="grid gap-2">
          ...
          <p className="px-8 text-center text-sm text-muted-foreground">
            Forgot password? {" "}
            <Button variant="link" className="px-0">Click here</Button>.
          </p>
        </div>
      </form >
